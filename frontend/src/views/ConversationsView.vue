...
<template>
    ...
    <!-- Chat bubbles -->
    <section class="float-left bg-blue-950 w-1/20 h-screen border-r-4 border-solid border-indigo-950">
    ...
    <!-- Messages -->
    <section class="float-right flex flex-col items-center h-screen w-19/20">
        <div class="flex flex-col justify-items-stretch bg-sky-800 h-9/10 w-full overflow-y-auto">
        ...
        <div class="flex flex-row items-center justify-items-center bg-blue-950 h-1/10 w-full border-t-4 border-solid border-indigo-950">
